# 6 - Courses and Relays

---
tagline: Put it all together and orienteer
epigraph: You are ready to navigate on your own
sidebar_position: 6
time: 70 minutes
space: Schoolyard, local park, or forested area with an orienteering map
materials:
  - Orienteering maps with courses (multiple difficulty levels)
  - Compasses (1 per student or pair)
  - Checkpoints (orienteering flags, streamers, or cones)
  - Checkpoint Copy Relay maps and blank maps (1 set per team)
  - Clipboards or flat surfaces for drawing
  - Markers (1 per team)
setup: Place checkpoints for point-to-point courses at multiple difficulty levels; prepare Checkpoint Copy Relay maps and blank maps
vocabulary:
  - Route choice
activities:
  - title: Checkpoint Copy Relay
    description: Teams race to memorize and copy checkpoint locations between maps.
    link: /activities/core/checkpoint-copy-relay
    tag: core
---
