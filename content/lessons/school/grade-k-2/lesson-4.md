...
setup: Place animal checkpoints around the space; prepare 5-animal clue sheets (and 10-animal sheets for pairs who finish all six)
vocabulary:
  - Clue sheet
  - Course
  - Checkpoint
...
1. [**Boundary Run**](/activities/core/boundary-run): quick review of the boundary. If students need a refresher on checkpoint locations, start with a quick round of [**Explore & Find**](/activities/core/explore-and-find).
...
4. [**Animal-O**](/activities/core/animal-o): pairs use clue sheets to find all 5 checkpoints in order.
...
1. **Boundary Run**: quick review (optional **Explore & Find** refresher)
2. Show a clue sheet; demonstrate the first checkpoint together as a class
3. Pair up (Navigator and Checker)
4. **Animal-O**: 5-animal clue sheets; find them in order
5. Switch roles; repeat the same course for speed
6. Challenge: from memory
7. Pairs who finish all six get a 10-animal sheet
