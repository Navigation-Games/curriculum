...
materials:
  ...
  - Pattern maps (simple dot maps with colored corners)
...
2. Gather facing the cones; show the whiteboard map
3. Hold it upside down; students say when it matches
4. **Find the Cone**: circle a dot; students go stand by that cone
5. Pair up; each pair gets a map with 2-3 checkpoints
6. **Geometric-O**: visit checkpoints in order; check the animal at each one
7. Finished pairs get a harder map
