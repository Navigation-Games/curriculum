...
activities:
  - title: Map Walk
    description: "Warm up: quick map walk to review symbols and thumbing."
...
1. [**Map Walk**](/activities/core/map-walk): quick warm-up route to review symbols and thumbing
...
1. **Map Walk**: quick warm-up
2. **Score-O introduction**: explain format and strategy
3. **Score-O**: first round in pairs (8-10 min), debrief, second round individual
4. Setup ladder (if time): students choose locations and place markers
