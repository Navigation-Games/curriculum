...
epigraph: Run your own race
sidebar_position: 6
time: 45-60 minutes
space: Schoolyard or local park with an orienteering map
materials:
  - Orienteering maps with multiple course options (easy, medium, hard)
...
activities:
  - title: Score-O
    description: "Warm up: quick Score-O round."
    link: /activities/core/score-o
    tag: warm-up
  - title: Point-to-Point
    description: Timed courses with individual starts.
    link: /activities/core/point-to-point
    tag: core
  - title: Relay Race
    description: Teams compete in relay format.
    tag: core
---
...
1. [**Score-O**](/activities/core/score-o): quick warm-up round (5 minutes)
...
1. **Score-O**: quick warm-up
2. **Race format**: staggered starts, choose your course difficulty, finish chute
3. **Individual timed runs**: pick up map, run course, self-check, finish through chute
4. **Second run**: faster time or harder course
5. **Relay Race**: teams of 3-4, relay format
6. **Cleanup**: students collect markers
