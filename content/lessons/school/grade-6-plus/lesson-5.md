...
activities:
  ...
  - title: Point-to-Point
    description: Navigate a course visiting checkpoints in order using a map.
...
2. **Introduce point-to-point**: explain the course format
...
3. **Introduce route choice vocabulary**:
...
4. [**Point-to-Point**](/activities/core/point-to-point): progression
