...
1. **Boundary Run**: quick warm-up
2. **Symbol introduction**: compare orienteering map to pattern maps; find symbols for nearby features
3. **Symbol-O**: in pairs, find checkpoints at features matching specific symbols
4. **Map Walk**: walk a route as a group, matching symbols to features
