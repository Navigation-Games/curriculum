...
1. **Boundary Run**: run the boundary of the court
2. **Find the Cone**: pair up, orient the map, stand next to the cone shown
3. **Basketball-O**: visit checkpoints in order
4. Do the course individually for speed
5. Try in reverse order and without a map
