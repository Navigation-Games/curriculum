...
- Short: Follow instructions
  Long: Follow instructions and search carefully within the boundary

- Short: Observation
  Long: Practice observation and finding things in a defined space

- Short: Spatial communication
  Long: Communicate the location of a hidden object to a partner using spatial language

- Short: Teamwork
  Long: Help others find their treasures after finding your own

## Vocabulary

- Boundary
  The limits of the playing area. All treasures are hidden inside the boundary.

- Clue
  Information that helps someone find a hidden object. Clues can be verbal directions, spatial descriptions, or marks on a map.

- Treasure
  The hidden object you are searching for. In Clothespin-O, the treasures are clothespins.
...
1. Explore the boundary together; quiz inside vs. outside
2. Explain the treasure hunt and the rules
3. Students search for hidden clothespins
4. When a student finds one, they bring it back and describe where they found it
5. After finding one, help a friend
6. If treasures remain hidden, give hints to narrow the search
7. Move to partner or map variations as time allows

## Compact Delivery

1. Explore the boundary
2. Search for hidden clothespins within the boundary
3. Bring each one back and describe where you found it
4. Help a friend find one after you find yours
5. Try partner or map variations
