...
Students move freely within a defined boundary while maintaining awareness of a teacher-led signal. When the signal is given, students must stop and return to the teacher as quickly and safely as possible.

Builds divided attention, group responsibility, and awareness in terrain.
...
- Short: Quick response
  Long: Respond quickly and safely to the gathering signal

- Short: Group communication
  Long: Communicate and coordinate with the group to improve gathering time

- Short: Free movement with confidence
  Long: Move freely within a defined space with confidence
...
2. Explain the gathering signal (e.g. whistle, raised hand)
3. Students move freely around the space using safe locomotor movement (walking, jogging, skipping)
4. On signal, students return to the teacher as quickly as possible
a. Count how many seconds it takes the class to gather
5. Repeat, with a goal of gathering more quickly
a. Encourage students to strategize to help the group gather faster
