...
- Short: Route planning
  Long: Plan a route through multiple checkpoints, choosing which to visit and in what order

- Short: Independent navigation
  Long: Navigate independently using an orienteering map to find checkpoints

- Short: Map reading
  Long: Read an orienteering map and match symbols to real features while moving
...
- Route choice
  The path you decide to take between checkpoints. There is no single correct route.

- Score-O
  A format where you earn points by visiting checkpoints in any order within a time limit.

- Feature
  A real-world object or landmark that appears as a symbol on the map. Trees, fences, paths, and buildings are all features.
...
1. Gather students; hand out maps and scorecards
2. Orient the map together; point out a few checkpoint locations
3. Discuss strategy briefly
4. Set the time limit and start
5. Students visit checkpoints in any order, recording codes
6. Whistle to end; students return to start
7. Score: count correct codes
