...
| **Materials** | Checkpoints, 4 colored landmark cones, clue sheets, pattern maps, answer keys |
| **Setup** | Set up checkpoints in a geometric pattern with colored landmark cones at corners |
| **Vocabulary** | Map, mental map, orient the map, landmark, spatial relationship words (next to, closest, furthest, between) |
...
- Relate a checkpoint on the map to the actual checkpoint
