...
| Session | Activity |
|---|---|
| [1. **Animal-O**](intro/lesson-1) | Find animal checkpoints in order using a clue sheet |
| [2. **Find Your Way Home**](intro/lesson-2) | Orient the map, navigate back to home base |
| [3. **Map Treasure Hunt**](intro/lesson-3) | Find checkpoints in any order using the map |

### [Camp Skill Development](full) (6 sessions)
...
|---|---|
| [1. **Getting Started**](full/lesson-1) | Meet the orienteering map; find checkpoints using clue sheets |
| [2. **Reading the Map**](full/lesson-2) | Walk with the map to learn symbols; navigate on your own |
| [3. **Compass and Courses**](full/lesson-3) | Learn the compass; run your first orienteering course |
| [4. **Precision and Teamwork**](full/lesson-4) | Follow a route precisely; relay with a partner |
| [5. **Compass Challenge**](full/lesson-5) | Apply compass skills; avoid the wrong checkpoints |
| [6. **Courses and Relays**](full/lesson-6) | Put it all together; race as a team |
