...
<CardGrid columns={2}>
  <ActivityCard
    ...
    description="Structured lesson progressions by grade band (K-2, 3-5, 6+), aligned to PE standards. Works for PE teachers and classroom teachers alike."
    link="/lessons/school"
  />
  <ActivityCard
    title="Orienteering at Camp"
    description="A 3-session intro for camps just getting started, and a 6-session skill development program for camps that want to go deep."
    link="/lessons/camp"
  />
</CardGrid>
