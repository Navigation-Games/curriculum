...
A single reference map showing the correct locations of all checkpoints. The leader uses it during setup and can post it for students to check their work.
...
| **Learning connection** | The master map is the "answer key." It lets the leader verify setup accuracy and gives students a reference for self-checking. |
