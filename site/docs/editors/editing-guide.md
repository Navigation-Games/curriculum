...
Activities and lesson plans are generated by the build script. Edit the source files, then run the build to update the site pages. Never edit the generated files directly.
...
| Camp landing | `site/src/pages/camp.mdx` |
