...
| Acknowledgments | `site/docs/reference/acknowledgments.md` |
| Copyright and License | `site/docs/reference/copyright.md` |
| Resources | `site/docs/reference/resources.md` |
| How to Use This Site | `site/docs/reference/how-to-use-this-site.md` |
...
Note: editing on GitHub skips the content build step. For generated activity and lesson pages to update, someone needs to run `node scripts/build-content.js` and commit the result. Directly-edited pages update immediately on deploy.
