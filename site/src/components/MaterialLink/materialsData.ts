...
const materialEntries: MaterialInfo[] = [
  ...
  {
    name: 'All-checkpoints map',
    description: 'A single map showing the correct locations of all checkpoints.',
    ...
    learningConnection: 'The all-checkpoints map is the "answer key." It lets the leader verify setup accuracy and gives students a reference for self-checking.',
  },
  {
  ...
  {
    name: 'Small whiteboard and markers',
    description: 'A small portable whiteboard used for the Geometric-O map introduction. The leader draws the checkpoint layout (with deliberate errors) while students watch and help fix orientation.',
    whereToGet: 'Classroom supplies, dollar stores',
    alternatives: 'Paper on a clipboard, large index card',
    usedIn: 'Geometric-O',
    learningConnection: 'The whiteboard introduction is where students first see a map being created. Drawing it live makes the connection between space and map concrete.',
  },
  {
    name: 'Results whiteboard',
    description: 'A large whiteboard on an easel (or paper on a clipboard) placed near start/finish for students to record their times and track which courses they have completed.',
    whereToGet: 'Classroom supplies, portable easel whiteboards from office supply stores',
    alternatives: 'Large paper pad on an easel, paper on a clipboard, poster board',
    usedIn: 'Animal-O, Geometric-O, Score-O',
    learningConnection: 'Visible time tracking is highly motivating. Students can see which courses they still need to do and compare times, which encourages repeat attempts and self-improvement.',
  },
  {
...
const keywordMap: Record<string, string> = {
  ...
  master: 'All-checkpoints map',
  reference: 'All-checkpoints map',
  'all-checkpoints': 'All-checkpoints map',
  ...
  'small whiteboard': 'Small whiteboard and markers',
  'results whiteboard': 'Results whiteboard',
  whiteboard: 'Small whiteboard and markers',
